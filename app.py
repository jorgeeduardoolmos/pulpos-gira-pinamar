...
def render_autorizacion():
    # Invisible anchor at top + JS scroll via iframe
    import streamlit.components.v1 as _c
    _c.html("<script>window.parent.document.querySelector('.main').scrollTop = 0;</script>", height=0)
    st.markdown('<div id="auth-top"></div>', unsafe_allow_html=True)
    st.markdown("""
    <style>
    ...
    with c1:
        st.markdown("""<div class="card">
            ...
            <div class="card-body">
                ...
                El rival que nos espera con el campo listo y el tercer tiempo preparado.<br><br>
                <a class="link-btn" href="https://maps.app.goo.gl/WRyYgsnV3P92DqL26" target="_blank">🗺️ Ver Club en Maps</a>
            </div>
        </div>""", unsafe_allow_html=True)
    with c2:
        st.markdown("""<div class="card">
